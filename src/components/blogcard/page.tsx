...
const BlogCard: React.FC<BlogCardProps> = ({ title, content, author = "Anonymous", date,  onDelete,id }) => {
    return (
        <Card
            className={cn(
            ...
            <div className="p-6">                                      
                ...
                <div className="mt-6 flex items-center justify-between text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <div className="flex space-x-2">
                        ...
                        <button onClick={onDelete} className="p-2 rounded hover:bg-gray-200 dark:hover:bg-gray-700">
